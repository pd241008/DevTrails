...
import { TrendingDown, AlertCircle, Users, Wallet } from "lucide-react";
    ...
    <div className="space-y-8">
      ...
      <div className="grid gap-8 md:grid-cols-2">
        ...
        <motion.div 
            ...
            className="premium-card p-8 min-h-[400px]"
        >
        ...
        >
          ...
          <p className="mt-6 text-[10px] text-zinc-500 font-bold uppercase tracking-widest text-center">
            Critical infrastructure alert active for Sector Alpha (Zone A)
          </p>
        </motion.div>
      </div>
    </div>
